...
/**
 * <p>Clase Java para turnData complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="turnData"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "turnData", namespace = "http://spring.io/guides/gs-producing-web-service", propOrder = {
    "id",
    "processType",
    "date",
    "code"
